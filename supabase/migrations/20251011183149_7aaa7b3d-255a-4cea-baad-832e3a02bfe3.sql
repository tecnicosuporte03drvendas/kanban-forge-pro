...
-- Copiar dados, convertendo 'assumida' para 'aceita'
UPDATE public.tarefas 
SET status_temp = CASE 
  WHEN status::text = 'assumida' THEN 'aceita'
  ELSE status::text
END;
...
-- Criar novo enum com 'aceita' ao invés de 'assumida'
CREATE TYPE public.status_tarefa AS ENUM ('criada', 'aceita', 'executando', 'concluida', 'validada');
...
-- Recriar função calculate_task_time (com 'aceita' ao invés de 'assumida')
...
-- Recriar função handle_task_status_change (com 'aceita' ao invés de 'assumida')
